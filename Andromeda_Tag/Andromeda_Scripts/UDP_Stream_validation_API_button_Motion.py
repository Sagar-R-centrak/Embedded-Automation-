...
time.sleep(5)
get_tester_feedback(
    "Now tag switches to BLE mode only please connect to tag via Andromeda mobile app and set operating mode as UHF only to proceed with test")
...
# ******************************************************************************************************************
print(
    "Executing Fsleep_03 : To Validate tag not enters into factory once it exits factory sleep through Long key press.  ")
