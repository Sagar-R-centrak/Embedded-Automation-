...
# Function to send a JSON message and receive the response
def send_json_message(server_ip, server_port, json_message):
    try:
        # Create a socket
...
if __name__ == "__main__":
    ...
    server_port = 8185       # Replace with the actual server port
...
'''
    # Call the function
    send_json_message(server_ip, server_port, json_request)
